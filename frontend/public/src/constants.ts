...
// * 52 - element selected (allie structure non occupied by unit) - buy unit menu
const STATE_52_ALLIE_STRUCTURE_SELECTED = 52;
// * 53 - element selected (map, no allie structure, non-occupied by unit) - end turn menu
const STATE_53_NON_ALLIE_STRUCTURE_SELECTED = 53; // STATE_53_NON_ALLIE_STRUCTURE_SELECTED used instead
...
// * 70 - Action result - 0
// const STATE_70_ACTION_RESULT = 70; // transitional state
// * 80 - end of player turn - 0
// const STATE_80_END_OF_PLAYER_TURN = 80; // transitional state
